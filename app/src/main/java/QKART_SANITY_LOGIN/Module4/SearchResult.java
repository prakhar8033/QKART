...
public class SearchResult {
    ...
    public Boolean closeSizeChart(WebDriver driver) {
        try {
            ...
            wait.until(ExpectedConditions.invisibilityOfElementLocated(By.tagName("table")));
    ...
    public Boolean validateSizeChartContents(List<String> expectedTableHeaders, List<List<String>> expectedTableBody,
        ...
        try {
             ...
             */
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
            wait.until(ExpectedConditions.numberOfElementsToBe(By.xpath("//table/thead/tr[1]/th"), 4));
    ...
    public Boolean verifyExistenceofSizeDropdown(WebDriver driver) {
        Boolean status = false;
        try {
            WebElement element = parentElement.findElement(By.xpath("./..")).findElement(By.className("css-13sljp9"));
